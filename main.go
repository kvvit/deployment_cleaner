						...
						for _, objectItem := range objects {
							...
							case "Deployments":
								...
								for _, objectName := range matchingObjects {
									...
									fmt.Printf("Deployment name: %s in namespace: %s has been deleted\n", objectName, nameSpace)
								}
							case "Secrets":
								...
								for _, objectName := range matchingObjects {
									...
									fmt.Printf("Secret name: %s in namespace: %s has been deleted\n", objectName, nameSpace)
								}
							case "ConfigMaps":
								...
								for _, objectName := range matchingObjects {
									...
									fmt.Printf("ConfigMap name: %s in namespace: %s has been deleted\n", objectName, nameSpace)
								}
							case "Services":
								...
								for _, objectName := range matchingObjects {
									...
									fmt.Printf("Service name: %s in namespace: %s has been deleted\n", objectName, nameSpace)
								}
							case "Ingress":
								...
								for _, objectName := range matchingObjects {
									...
									fmt.Printf("Ingress name: %s in namespace: %s has been deleted\n", objectName, nameSpace)
								}
							}
						}
					}
